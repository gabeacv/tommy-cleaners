...
const mockClients = [
    { id: 1, first_name: 'Emma', last_name: 'Watson', email: 'emma@watson.co.uk', phone: '+1 (555) 902-1234', address: '123 Upper East Side, NY', status: 'active', frequency: 'weekly', cleaner: 'Tommy' },
    { id: 2, first_name: 'John', last_name: 'Doe', email: 'john@doe.com', phone: '+1 (555) 123-4567', address: '456 Wall St, NY', status: 'active', frequency: 'bi-weekly', cleaner: 'Sarah' },
    { id: 3, first_name: 'Alice', last_name: 'Smith', email: 'alice@smith.org', phone: '+1 (555) 789-0123', address: '789 Brooklyn Heights, NY', status: 'inactive', frequency: 'on-demand', cleaner: '-' }
];
